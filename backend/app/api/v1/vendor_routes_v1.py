...
@router.get("/get-all-vendors", summary="Get all vendors")
...
@router.get("/get-vendor-details-by-id", summary="Get vendor by ID")
...
@router.post("/create-new-vendor", summary="Create new vendor", status_code=status.HTTP_201_CREATED)
...
@router.put("/update-vendor-details", summary="Update existing vendor")
...
@router.delete("/delete-vendor", summary="Soft delete vendor", status_code=status.HTTP_204_NO_CONTENT)
